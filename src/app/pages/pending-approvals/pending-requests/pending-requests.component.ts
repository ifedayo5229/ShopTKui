...
throw new Error('Method not implemented.');
  ...
  getinfo(){
    debugger
      ...
      this.isStoreManager = this.userRoles.includes('Store Manager') || this.userRoles.includes('Main Store Manager');
      this.isHoS = this.userRoles.includes('HOS');
      this.isLineManager = this.userRoles.includes('Line Manager');
      console.log(this.isHoS);
    } 


        async getAllPendingRequests() {
          debugger
          let resGetAllPendingRequests = await this.itemRequestService.getallPendingRequests(this.userId).toPromise();
        ...
        issueRequests (requestId: number) {
          debugger
          const dialogConfig = new MatDialogConfig();
          dialogConfig.data = { selectedRequestId: requestId, isHos: this.isHoS, isLineManager: this.isLineManager, isStoreManager: this.isStoreManager};
          const dialogRef = this.dialog.open(IssueRequestsComponent, dialogConfig);
