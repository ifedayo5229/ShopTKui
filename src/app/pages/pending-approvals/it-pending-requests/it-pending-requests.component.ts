...
@Component({
  selector: 'app-it-pending-requests',
  templateUrl: './it-pending-requests.component.html',
  styleUrls: ['./it-pending-requests.component.scss']
})
export class ItPendingRequestsComponent implements OnInit {
closeDialog() {
    ...
    debugger
      ...
      this.userRoles = userRoles;
        ...
        async getAllPendingRequests() {
          debugger
          let resGetAllPendingRequests = await this.itemRequestService.getallPendingItRequests(this.userEmail).toPromise();
        ...
        approveRequest (requestId: number) {
          ...
          const dialogRef = this.dialog.open(ItApproveDialogComponent, dialogConfig);
        ...
        rejectRequest (requestId: number) {
          ...
          const dialogConfig = new MatDialogConfig();
          dialogConfig.data = { selectedRequestId: requestId, isHos: this.isHoS, isLineManager: this.isLineManager, isStoreManager: this.isStoreManager};
          const dialogRef = this.dialog.open(ItRejectDialogComponent, dialogConfig);
