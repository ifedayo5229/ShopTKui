...
@Component({
  selector: 'app-ghet-requests-for-cpasd',
  templateUrl: './ghet-requests-for-cpasd.component.html',
  styleUrls: ['./ghet-requests-for-cpasd.component.scss']
})
export class GhetRequestsForCpasdComponent implements OnInit {
